...
INSERT INTO `euskallovers`.`Usuario` (`Nick`, `Email`, `Password`, `Genero`, `Edad`, `Altura`, `Peso`, `Constitucion`, `Ciudad`, `CP`, `Foto`) VALUES ('Adrián', 'adrian@adrian.com', 'adrian', 67, 20, 1.70, 70, 'Fornido', 'San Sebastian', '01010', 'lalala');
...
INSERT INTO `euskallovers`.`Aficion` (`Nombre`, `Nick`) VALUES ('Teconologia', 'AsierLO');
...
START TRANSACTION;
USE `euskallovers`;
INSERT INTO `euskallovers`.`Personalidad` (`Nick`, `Nombre`) VALUES ('AsierLO', 'Alegre');
